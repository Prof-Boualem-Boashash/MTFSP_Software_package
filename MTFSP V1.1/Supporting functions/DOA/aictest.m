...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                   AIC test for number of sources estimation
%
% Syntax : NSIG = aictest(x)
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% <INPUTs>
...
Ld = zeros(N,1);
for ii=1:N
    Ld(ii) = K*(N-ii)*log(mean(eigenvals(ii+1:N))/(prod(eigenvals(ii+1:N))^(1/(N-ii)))) + (ii*(2*N-ii));
end
[~,NSIG] = min(Ld);      
end
